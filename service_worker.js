...
// This an a copy of the service worker at: https://github.com/HackTestes/TTS_WebApp/blob/master/src/service_worker.js
// I have only changed the parameters for this particular page path
const version = "1"
const urls = [
    "./clock.html",
    "./manifest.json",
...
const cache_name = "clock-web-app"
